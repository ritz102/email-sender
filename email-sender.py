...
sender_email = 'surisettiritvik0@gmail.com' #Gmail account that the email will be sent from.
google_apps_password = 'yatzcvkpbksoonjr' # This key is unique for every google account.
reciverers_email = 'flyingrussian45@gmail.com' #Gmail account that the email will be recieved to.
